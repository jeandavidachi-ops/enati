...
const HTML = `
<div style="max-width:1600px; margin:0 auto; padding:24px; display:grid; grid-template-columns:470px 1fr; gap:18px; align-items:start; font-family:'Inter',system-ui,sans-serif;">
