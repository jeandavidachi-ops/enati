...
<div style="padding:38px;box-sizing:border-box;font-family:'Inter',sans-serif;">
  ...
  <div style="display:flex;flex-direction:column;gap:18px;">
    ...
    <div style="border:1px solid #253036;border-radius:8px;background:#101314;">
      <div style="padding:22px 26px 18px 26px;border-bottom:1px solid #1b2429;">
        <h2 style="margin:0;color:#ffffff;font-size:18px;font-weight:700;line-height:1;">Connected Accounts</h2>
        <p style="margin:8px 0 0 0;color:#8b9599;font-size:13px;font-weight:400;line-height:1;">Link your social accounts to verify your identity</p>
      </div>
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;gap:24px;padding:20px 0;border-bottom:1px solid #1b2429;">
          <div style="display:flex;align-items:center;gap:15px;">
            ...
            <div style="display:flex;flex-direction:column;gap:6px;">
              <span style="color:#ffffff;font-size:14px;font-weight:600;line-height:1;">X Account</span>
              <span style="color:#8b9599;font-size:13px;font-weight:400;line-height:1;">Not connected</span>
            </div>
          </div>
          <button style="height:40px;padding:0 20px;background:transparent;border:1px solid #253036;border-radius:7px;color:#d3d9db;font-size:14px;font-weight:600;cursor:pointer;font-family:inherit;flex-shrink:0;">Connect X</button>
        </div>
        <div style="display:flex;align-items:center;justify-content:space-between;gap:24px;padding:20px 0;">
          <div style="display:flex;align-items:center;gap:15px;">
            <div style="width:42px;height:42px;border-radius:8px;background:#0d1112;border:1px solid #253036;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="#c4ccce" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21.5 4.5L2.5 11.5l6.5 2.2M21.5 4.5L18 20l-6-6M21.5 4.5L9 13.7M9 13.7V19l3-2.9"></path></svg>
            </div>
            <div style="display:flex;flex-direction:column;gap:6px;">
